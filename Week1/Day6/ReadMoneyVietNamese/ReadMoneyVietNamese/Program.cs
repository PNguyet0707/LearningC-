...
namespace ReadMoneyVietNamese
{
    internal class MyProgram 
    {
        ...
        private static List<string> ListThree(long a)
        {
            long tam = a;
        ...
        private static string ReadLetter(char b)
        {
        ...
        private static string ReadOne(string a)
        {
        ...
        private static string ReadTwo(string a)
        {
        ...
        private static string ReadMoney(long number, string Choice)
        {
            string[] donvi = {"Đồng ","Nghìn ","Triệu ", "Tỷ " ,"Nghìn Tỷ ", "Triệu Tỷ ", "Tỷ Tỷ "};
            string result = " ";
